...
const UNITES_A_DEBLOQUER = ['mage','trebuchet','electromancer','cryomancer',
  'pyromancer','mole','cavalier','necromancer','bannerman','lizard','plantSpirit',
...
const rarities={
 ...
 skeletonCard:['🔵','Rare'],
 skeletonGeneral:['🟠','Légendaire'], plantSpirit:['🟠','Légendaire'],
...
const DMG_BATIMENT={
 ...
 necromancer:8, bannerman:8, skeleton:3, lizard:10, plantSpirit:18, ancientTree:0,
...
ancientTree:{hp:520,dmg:0,speed:0,range:0,color:'#6b4a2e'},
...
const BODY={
  ...
  plantSpirit:{r:27,m:12}, ancientTree:{r:24,m:14}
}[type] || {r:20,m:3};
this.radius=BODY.r;
this.mass=BODY.m;
