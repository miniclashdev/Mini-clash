...
const UNITES_A_DEBLOQUER = ['mage','trebuchet','electromancer','cryomancer',
  'pyromancer','mole','cavalier','necromancer','bannerman',
...
const rarities={
 ...
 skeletonCard:['🔵','Rare'],hauntedCarriage:['🟣','Épique'],
...
const DMG_BATIMENT={
 ...
 necromancer:8, bannerman:8, skeleton:3,
...
if(target){
 ...
 if(this.type!=='healer'){
   ...
   const moveSpeed=(this.slowTime>0?this.speed*0.6:this.speed)*RALLY_SPEED;
   const dir=this.team==='player'?1:-1;
...
if(t==='necromancer'||t==='bannerman'||t==='skeleton'||t==='skeletonCard'
   ...
   ||t==='boneGuard'||t==='trebuchet'||t==='siegeman'){
  ctx.save();
