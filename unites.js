...
const LANGUE_RECHARGE = 40;    // repos entre deux harponnages
...
if(this.type==='lizard'){
  ...
  if(this.phase==='chasse' && this.recharge<=0){
    ...
    for(let i=0;i<unitsArr.length;i++){
      ...
      // Aucune distance minimale : il harponne aussi ce qui est devant lui.
      // C'est SON attaque, pas un bonus réservé aux cibles lointaines.
